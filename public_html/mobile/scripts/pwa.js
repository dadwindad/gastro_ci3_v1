...
$(document).ready(function () {
  ...
  var isInWebAppChrome = window.matchMedia(
  ...
  function updateModal() {
    ...
    var mt = new Date();
    var menuUpdate =
      mt.getHours() + ":" + mt.getMinutes() + ":" + mt.getSeconds();
      ...
      function versionCheck() {
        ...
        setTimeout(function () {
          ...
          if (
            ...
            updateModal();
            console.log(
              "New Version of Content Available. Refreshing. On Desktop Browsers a manual refresh maybe required."
            );
            setTimeout(function () {
