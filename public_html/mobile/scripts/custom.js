...
$(document).ready(function () {
  ...
  function init_template() {
    if (window.location.href.split("/")[4] == "culture-map.php") {
      $.getScript("scripts/culture.js", function () {
        callMap();
      });
    }
    if (window.location.href.split("/")[4] == "gastro-map.php") {
      $.getScript("scripts/gastro.js", function () {
        loadFilter();
        filterData();
      });
    }
