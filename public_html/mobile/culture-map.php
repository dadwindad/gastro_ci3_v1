...
<body class="theme-light" data-highlight="blue2">
    ...
    <div id="page">
        ...
        <div id="footer-bar" class="footer-bar-5">
            <a href="gastro-map.php"><i data-feather="coffee" data-feather-line="1" data-feather-size="21"
                    data-feather-color="red2-dark" data-feather-bg="red2-fade-light"></i><span>GASTRO Map</span></a>
            ...
            <a href="culture-map.php" class="active-nav"><i data-feather="map-pin" data-feather-line="1"
                    data-feather-size="21" data-feather-color="green1-dark"
                    data-feather-bg="green1-fade-light"></i><span>Culture
                    Map</span></a>
        ...
        <div class="page-content" style="min-height: 60vh !important">
            <div class="page-title page-title-small">
                <h2>
                    <a href="#" data-back-button><i class="fa fa-arrow-left"></i></a>แผนที่ท่องเที่ยววัฒนธรรม
                </h2>
            ...
            <div class="card card-style">
                <div class="content">
                    ...
                    <div id="gastro">
                        <div class="leaflet-map" id="layer-control-culture-map"></div>
